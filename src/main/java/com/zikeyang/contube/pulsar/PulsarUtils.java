...
public class PulsarUtils {
    ...
    public static ClassLoader extractClassLoader(String userCodeFile) throws IOException, URISyntaxException {
    ...
    public static String getSinkClassName(String sinkClassName, ClassLoader sinkClassLoader) throws IOException {
